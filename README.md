...
If I had more time, I would have given the user the option to change the status for each task.  I probably would have been able to do it if the data had been displayed as a list for each task, but since I used a table, I was unable to figure out how to give the user access to a different status within the time limit.  I would have also made the html more accessible and made the page more attractive with CSS styling.  Overall, I'm pretty happy with the outcome of this project.  It was difficult to complete in the time alloted, so I feel that I did a good job with the DOM manipulation and the data handling in JavaScript.